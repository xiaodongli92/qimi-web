    ...
    <div class="row row-3">
        ...
        <div class="col-md-9">
            ...
            <div class="row">
                <h4>经营范围</h4>
                <div class="col-md-12">
                    <p class="text1">利用存储转发机制为用户提供信息发送的业务,包括语音信箱、电子邮件、传真存储转发等业务。</p>
                </div>
            </div>
            <div class="row">
                <h4>申请基本条件</h4>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
			        <span class="part1">
				        <a href="javascript:void(0);" style="font-size: 17px;">全网存储转发类业务许可证申请</a>
			        </span>
                    <div class="line1">
                    ...
                    <div>
                        <p class="text1">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;全网存储转发类业务许可证申请是指企业利用存储转发机制为用户提供信息发送的业务，需申请许可牌照，否则属于违规经营。注：全网在工信部申请。
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
			        <span class="part1">
				        <a href="javascript:void(0);" style="font-size: 17px;">地网存储转发类业务许可证申请</a>
			        </span>
                    <div class="line1">
                        <div class="line2 theme"></div>
                    </div>
                    <div>
                        <p class="text1">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地网存储转发类业务许可证申请是指企业利用存储转发机制为用户提供信息发送的业务，需申请许可牌照，否则属于违规经营。注：地网在公司注册所在地通信管理局申请。
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
			        <span class="part1">
				        <a href="javascript:void(0);" style="font-size: 17px;">存储转发类业务许可证变更</a>
			        </span>
                    <div class="line1">
                        <div class="line2 theme"></div>
                    </div>
                    <div>
                        <p class="text1">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;存储转发类业务许可证变更是指变更原有存储转发类业务许可证上的公司名称、法定代表人、注册地址、注册资金、通信地址、联系电话、联系人、股东及股东资金结构等信息。注：全网在工信部申请，地网在公司注册所在地的通信管理局申请。
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
			        <span class="part1">
				        <a href="javascript:void(0);" style="font-size: 17px;">存储转发类业务许可证年检</a>
			        </span>
                    <div class="line1">
                        <div class="line2 theme"></div>
                    </div>
                    <div>
                        <p class="text1">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;存储转发类业务许可证年检是指每年1-3月（注：全网3-6月），持有者向主管部门提交公司的存储转发类业务情况，主管部门对公司持有的牌照进行常规真实性检查，合格者加盖年检合格章，如未按时年检或有违规虚假信息，主管部门将吊销公司许可牌照。注：全网在工信部申请，地网在公司注册所在地的通信管理局申请。
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
			        <span class="part1">
				        <a href="javascript:void(0);" style="font-size: 17px;">存储转发类业务许可证注销</a>
			        </span>
                    <div class="line1">
                        <div class="line2 theme"></div>
                    </div>
                    <div>
                        <p class="text1">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;存储转发类业务许可证注销是指原有存储转发类业务许可证未到或者已到批准期限，存储转发类业务许可证持证公司因业务因素而不在需要使用该证书，就需要向主管部门提交注销申请。注：全网在工信部申请，地网在公司注册所在地的通信管理局申请。
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
			        <span class="part1">
				        <a href="javascript:void(0);" style="font-size: 17px;">存储转发类业务许可证续期</a>
			        </span>
                    <div class="line1">
                        <div class="line2 theme"></div>
                    </div>
                    <div>
                        <p class="text1">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;存储转发类业务许可证续期是指原有存储转发类业务许可证有效期到期后，公司想要继续使用，就需要向主管部门提交续办申请。注：全网在工信部申请，地网在公司注册所在地的通信管理局申请。
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <h4>申请流程</h4>
                <div class="col-md-12">
                    <a href="javascript:void(0);" class="thumbnail"><img class="img-responsive model-img" src="${ctx}/static/images/cczfa01.png" alt="cczfa01"></a>
                </div>
            </div>
            <div class="row">
                <h4>企业必备资料</h4>
...
<script>
    $(function () {
        ...
        $("#storeForward").removeClass("menu-item-left");
        $("#storeForward").addClass("leftMenuActive");
    })
    $(function () {

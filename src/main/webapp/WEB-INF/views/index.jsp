...
<div id="ad-carousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="${ctx}/static/images/xinl2.jpg" alt="1 slide">
        </div>
        <div class="item">
            <img src="${ctx}/static/images/xinl3.jpg" alt="2 slide">
        </div>
        <div class="item">
            <img src="${ctx}/static/images/xinl4.jpg" alt="3 slide">
        </div>
        <div class="item">
            <img src="${ctx}/static/images/xinl5.jpg" alt="4 slide">
        </div>
    </div>
